    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-7">
      ...
      <motion.div variants={item}>
        <div className="flex items-center justify-between mb-3">
          <p className="text-[11px] font-semibold tracking-widest uppercase text-slate-400">
            Bir gezide seni en çok ne mutlu eder?
          </p>
      ...
      <motion.div variants={item}>
        <p className="text-[11px] font-semibold tracking-widest uppercase text-slate-400 mb-2">
          Bonus hikaye <span className="normal-case font-normal text-slate-400">(opsiyonel)</span>
        </p>
        <p className="text-sm text-slate-500 leading-relaxed mb-3">
          En unutulmaz — ya da en çok güldüğün — seyahat anın ne oldu?
        </p>
        <textarea
          id="memorable-moment"
          rows={3}
          placeholder="Örnek: Yanlış otobüse binip şehrin en güzel manzaralı kafesini keşfettim…"
